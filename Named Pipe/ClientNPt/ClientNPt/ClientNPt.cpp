...
{
	system("chcp 1251");
	cout << "Клиент Named Pipe t " << endl << endl;
	...
	try
	{
		...
		for (int i = 0; i<10; i++)
		{
			if ((hNP = CreateFile(L"\\\\DESKTOP-QN697QT\\pipe\\Tube", GENERIC_WRITE | GENERIC_READ, FILE_SHARE_WRITE | FILE_SHARE_READ, NULL, OPEN_EXISTING, NULL, NULL)) == INVALID_HANDLE_VALUE)
