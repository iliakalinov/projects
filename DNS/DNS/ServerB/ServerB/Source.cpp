...
bool PutAnswerToClient(char* name, SOCKET sock, sockaddr* to, int* lto)//отправка смс;
{
	int lbuf;
...
bool GetRequestFromClient(char* name, SOCKET sock, sockaddr* from, int* flen)//принятия смс;
{
	int lbuf;
	char ibuf[50];
